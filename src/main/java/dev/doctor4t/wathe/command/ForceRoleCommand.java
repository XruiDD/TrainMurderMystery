...
public class ForceRoleCommand {
    ...
    public static void register(@NotNull CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("wathe:forceRole").requires(Permissions.require(WathePermissions.COMMAND_FORCE_ROLE, WathePermissions.DEFAULT_COMMAND_LEVEL))
                .then(CommandManager.argument("players", EntityArgumentType.players())
                        ...
                        .then(CommandManager.argument("role", StringArgumentType.string())
                                ...
                                .executes(context -> execute(context.getSource(), EntityArgumentType.getPlayers(context, "players"), StringArgumentType.getString(context, "role")))
                        )
                )
        );
    }

    private static int query(@NotNull ServerCommandSource source, @NotNull Collection<ServerPlayerEntity> targetPlayers) {
    ...
    private static int execute(@NotNull ServerCommandSource source, @NotNull Collection<ServerPlayerEntity> targetPlayers, @NotNull String roleName) throws CommandSyntaxException {
