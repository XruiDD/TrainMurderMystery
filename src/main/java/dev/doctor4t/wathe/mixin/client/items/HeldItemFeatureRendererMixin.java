...
public class HeldItemFeatureRendererMixin {
    ...
    public ItemStack wathe$hideNoteAndRenderPsychosisItems(LivingEntity instance, Operation<ItemStack> original) {
        ...
        if (WatheClient.moodComponent != null && WatheClient.moodComponent.shouldShowPsychosisItems() && !instance.isInvisible()) { // make sure it's only the main hand item that's being replaced
